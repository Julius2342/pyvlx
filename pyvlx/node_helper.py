...
def convert_frame_to_node(pyvlx, frame):
    ...
    if (
            frame.node_type in (NodeTypeWithSubtype.ROLLER_SHUTTER, NodeTypeWithSubtype.DUAL_ROLLER_SHUTTER)
    ):
    ...
    if (
            frame.node_type in (NodeTypeWithSubtype.INTERIOR_VENETIAN_BLIND,
    ...
    if (
            frame.node_type in (NodeTypeWithSubtype.EXTERIOR_VENETIAN_BLIND,
    ...
    if (
            frame.node_type in (NodeTypeWithSubtype.VERTICAL_EXTERIOR_AWNING,
    ...
    if (
            frame.node_type in (NodeTypeWithSubtype.GARAGE_DOOR_OPENER,
    ...
    if (
        frame.node_type in (NodeTypeWithSubtype.LIGHT,
                            NodeTypeWithSubtype.LIGHT_ON_OFF)
    ):
        return Light(
            pyvlx=pyvlx,
            node_id=frame.node_id,
