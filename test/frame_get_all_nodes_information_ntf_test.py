...
from pyvlx.frame_get_all_nodes_information import FrameGetAllNodesInformationNotification
...
class TestFrameGetAllNodesInformationNotification(unittest.TestCase):
    ...
    EXAMPLE_FRAME = b'\x00|\x02\x04\x17\x04\xd2\x02Fnord23\x00\x00\x00\x00\x00' \
    ...
    def test_str(self):
        ...
        self.assertEqual(
            str(frame),
            '<FrameGetAllNodesInformationNotification node_id=23 oder=1234 placement=2 '
