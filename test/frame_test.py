...
class TestFrame(unittest.TestCase):
    ...
    def test_validate_payload_len_no_payload_len_defined(self) -> None:
    ...
    def test_validate_payload_len_payload_len_defined(self) -> None:
        """Test validate_payload_len_function with defined PAYLOAD_LEN."""
        frame = FrameBase(command=Command.GW_GET_NODE_INFORMATION_REQ)
        frame.PAYLOAD_LEN = 23
        frame.validate_payload_len(bytes(23))

    def test_validate_payload_len_payload_len_error(self) -> None:
