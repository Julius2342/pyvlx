...
class TestFrameNodeStatePositionChangedNotification(unittest.TestCase):
    ...
    def test_bytes(self):
        ...
        frame.node_id = 5
        frame.state = 5
        frame.current_position.position = 51200
        frame.target.position = 51200
    ...
    def test_frame_from_raw(self):
        ...
        self.assertEqual(frame.current_position_fp1.position, 63487)
    ...
    def test_str(self):
        ...
        self.assertEqual(
            ...
            'current_position_fp4=\'UNKNOWN\' remaining_time=0 time=\'{}\'/>'.format(test_ts))
