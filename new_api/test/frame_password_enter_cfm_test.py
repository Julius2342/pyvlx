...
from pyvlx.frame_password_enter import FramePasswordEnterConfirmation, PasswortEnterConfirmationStatus
...
class TestFramePasswordEnterConfirmation(unittest.TestCase):
    ...
    def test_discover_node_request_error(self):
        ...
        frame = FramePasswordEnterConfirmation(status=PasswortEnterConfirmationStatus.FAILED)
    ...
    def test_discover_node_request_from_raw(self):
        ...
        self.assertEqual(frame.status, PasswortEnterConfirmationStatus.FAILED)
